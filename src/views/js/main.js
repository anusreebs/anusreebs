    ...
    switch (x) {
        case "dark":
            var dark = ["dark", "morbid", "scary", "spooky", "gothic",
                ...
                "dejected", "haunted",
                "morose", "tragic", "shattered", "broken", "sad",
        ...
        case "color":
            var colors = ["blue", "green", "purple", "grey", "scarlet",
                ...
                "magenta",
                "chestnut", "rosy", "copper", "crimson", "teal", "indigo",
                "navy", "azure", "periwinkle", "brassy", "verdigris",
                "veridian", "tan",
        ...
        case "whimsical":
            var whimsy = ["whimsical", "silly", "drunken", "goofy", "funny",
                ...
                "breakdancing",
                "hilarious", "conceited", "happy", "comical", "curious",
                "peculiar", "quaint", "quirky", "fancy", "wayward",
                "fickle", "yawning", "sleepy",
                "cockeyed", "dizzy", "dancing", "absurd", "laughing",
                "hairy", "smiling", "perplexed", "baffled", "cockamamie",
                "vulgar", "hoodwinked",
                "brainwashed"
            ];
            return whimsy;
        ...
        case "noisy":
            var noisy = ["untuned", "loud", "soft", "shrieking", "melodious",
                ...
                "crying", "howling",
                "yelling", "hollering", "caterwauling", "bawling",
                "bellowing", "roaring", "squealing", "beeping", "knocking",
                "tapping", "rapping",
        ...
        case "apocalyptic":
            var apocalyptic = ["nuclear", "apocalyptic", "desolate", "atomic",
                ...
                "cannibalistic",
                "radioactive", "toxic", "poisonous", "venomous",
                "disastrous", "grimy", "dirty", "undead", "bloodshot",
        ...
        case "insulting":
            var insulting = ["stupid", "idiotic", "fat", "ugly", "hideous",
                ...
                "hollow", "vacuous",
                "boring", "insipid", "tedious", "monotonous", "weird",
                "bizarre", "backward", "moronic", "ignorant",
        ...
        case "praise":
            var praise = ["beautiful", "intelligent", "smart", "genius",
                ...
                "interesting", "divine", "alluring", "ravishing",
                "wonderful", "magnificient", "marvelous",
                "dazzling", "cute", "charming", "attractive", "nifty",
                "delightful", "superior", "amiable", "gentle", "heroic",
                "courageous", "valiant", "brave",
                "noble", "daring", "fearless", "gallant", "adventurous",
                "cool", "enthusiastic", "fierce", "awesome", "radical",
                "tubular", "fearsome",
        ...
        case "scientific":
            var scientific = ["scientific", "technical", "digital",
                ...
                "space", "theoretical", "atomic", "electronic", "gaseous",
                "investigative", "solar",
                "extinct", "galactic"
            ];
            return scientific;
    ...
    switch (y) {
        case "animals":
            var animals = ["flamingo", "hedgehog", "owl", "elephant",
                ...
                "crocodile", "kangaroo",
                "wallaby", "woodpecker", "eagle", "falcon", "canary",
                "parrot", "parakeet", "hamster", "gerbil", "squirrel",
                "rat", "dove", "toucan",
                "raccoon", "vulture", "peacock", "goldfish", "rook",
                "koala", "skunk", "goat", "rooster", "fox", "porcupine",
                "llama", "grasshopper",
                "gorilla", "monkey", "seahorse", "wombat", "wolf",
                ...
                "buzzard", "vulture",
                "rhino", "hippopotamus", "dolphin", "sparrow", "beaver",
                "moose", "minnow", "otter", "bat", "mongoose", "swan",
                "firefly", "platypus"
            ];
            return animals;
        case "profession":
            var professions = ["doctor", "lawyer", "ninja", "writer", "samurai",
                ...
                "director", "mayor", "merchant", "detective",
                "investigator", "navigator", "pilot",
                "priest", "cowboy", "stagehand", "soldier", "ambassador",
                "pirate", "miner", "police"
            ];
            return professions;
        case "fantasy":
            var fantasy = ["centaur", "wizard", "gnome", "orc", "troll",
                ...
                "changeling", "ghost",
                "knight", "squire", "magician", "witch", "warlock",
                "unicorn", "dragon", "wyvern", "princess", "prince", "king",
                "queen", "jester",
        ...
        case "music":
            var music = ["violin", "flute", "bagpipe", "guitar", "symphony",
                ...
                "soprano", "baritone", "cello", "viola", "piccolo",
        ...
        case "gross":
            var gross = ["slime", "bug", "roach", "fluid", "pus", "booger",
                ...
                "phlegm",
                "centipede", "beetle", "fart", "snot", "crevice",
                "flatulence", "juice", "mold", "mildew", "germs",
        ...
        case "everyday":
            var everyday = ["mirror", "knife", "fork", "spork", "spoon",
                ...
                "television", "TV",
                "book", "car", "truck", "soda", "door", "video", "game",
                "computer", "calender", "tree", "plant", "flower",
        ...
        case "jewelry":
            var jewelry = ["earrings", "ring", "necklace", "pendant", "choker",
                ...
                "blingBling", "chain", "rosary", "jewel", "gemstone",
                "beads", "armband", "pin",
        ...
        case "places":
            var places = ["swamp", "graveyard", "cemetery", "park", "building",
                ...
                "woods", "neighborhood",
                "city", "town", "suburb", "country", "meadow", "cliffs",
                "lake", "stream", "creek", "school", "college",
                "university", "library", "bakery",
                "shop", "store", "theater", "garden", "canyon", "highway",
                "restaurant", "cafe", "diner", "street", "road", "freeway",
                "alley"
            ];
            return places;
        case "scifi":
            var scifi = ["robot", "alien", "raygun", "spaceship", "UFO",
                ...
                "timeTraveler", "scientist", "invention", "martian",
...
var resizePizzas = function(size) {
    ...
    // assign document.getElementById("pizzaSize").innerHTML to pizzaInnerHTML
    ...
    //removed additional computations using offsetWidth
    function changePizzaSizes(size) {
        var pizzaContainers = document.getElementsByClassName(
...
//optimized the code by removing extra computation inside the loop
function updatePositions() {
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        //used transform instead of left to move the pizzas
        items[i].style.transform = "translateX(" + (items[i].basicLeft - 900 +
            100 * phase) + "px)";
    }
